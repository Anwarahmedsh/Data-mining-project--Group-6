...
clinical data such as T-Stage, age, and N-Stage. This enables a more
...
-   Types of attribute :
    ...
    +----------+----------------------------+----------+-----------------+
    | **A      | **Description**            | **Data   | **Possible      |
    | ttribute |                            | type**   | values**        |
    | name**   |                            |          |                 |
    +:=========+:===========================+:=========+:================+
    | Age      | age of the patients        | numeric  | between 30 - 70 |
    +----------+----------------------------+----------+-----------------+
    | Race     | classification of people   | nominal  | white, black or |
    |          | based on their physical    |          | other           |
    |          | characteristics such as    |          |                 |
    |          | skin color                 |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Marital  | refers to wether the       | nominal  | Divorced        |
    | status   | patient is married ,single |          | ,Married,       |
    |          | or divorced etc            |          | Separated,      |
    |          |                            |          | Single ,        |
    |          |                            |          | Widowed         |
    +----------+----------------------------+----------+-----------------+
    | T stage  | describe the tumors size   | ordinal  | T1,T2,T3,T4     |
    |          | and if it has spread to    |          |                 |
    |          | the skin or to the chest   |          |                 |
    |          | wall under the breast.     |          |                 |
    |          | Higher T numbers mean a    |          |                 |
    |          | larger tumor               |          |                 |
    +----------+----------------------------+----------+-----------------+
    | N stage  | indicates whether the      | ordinal  | N1 ,N2,N3       |
    |          | cancer has spread to lymph |          |                 |
    |          | nodes near the breast      |          |                 |
    +----------+----------------------------+----------+-----------------+
    | 6th      | describes invasive breast  | Ordinal  | IIA , IIB ,     |
    | stage    | cancer                     |          | IIIA , IIIB ,   |
    |          |                            |          | IIIC            |
    +----------+----------------------------+----------+-----------------+
    | Differe  | describes how well         | ordinal  | Moderately      |
    | ntiation | developed the tumour cells |          | differentiated  |
    |          | are and how cancer cells   |          | , Poorly        |
    |          | are organised in the       |          | differentiated  |
    |          | tumour tissue              |          | ,U              |
    |          |                            |          | ndifferentiated |
    |          |                            |          | , Well          |
    |          |                            |          | differentiated  |
    +----------+----------------------------+----------+-----------------+
    | Grade    | depends on what the cells  | ordinal  | 1,2 ,3, 4       |
    |          | look like, lower grade     |          |                 |
    |          | indicates slower-growing   |          |                 |
    |          | cancer unlike higher       |          |                 |
    |          | grades                     |          |                 |
    +----------+----------------------------+----------+-----------------+
    | A stage  | Regional : aneoplasm that  | as       | Distant,        |
    |          | has extended, Distant :    | ymmetric | Regional        |
    |          | aneoplasm that has spread  | binary   |                 |
    |          | to parts of the body       |          |                 |
    |          | remote from                |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Tumor    | Each indicates exact size  | ordinal  | FROM 1 TO 140   |
    | size     | of the tumor in            |          |                 |
    |          | millimeters                |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Estrogen | The cancer is estrogen     | as       | Negative,       |
    | status   | receptor-positive if it    | ymmetric | Positive        |
    |          | has receptors for estrogen | binary   |                 |
    +----------+----------------------------+----------+-----------------+
    | Prog     | The cancer is progesterone | as       | Negative ,      |
    | esterone | receptor-positive if it    | ymmetric | Positive        |
    | status   | has progesterone           | binary   |                 |
    |          | receptors.                 |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Regional | the number of the regional | numeric  | FROM 1 TO 61    |
    | Node     | node that have been        |          |                 |
    | Examined | examined                   |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Reginol  | the number of the regional | numeric  | FROM 1 TO 46    |
    | Node     | node that heve been        |          |                 |
    | Positive | confirmed to have cancer   |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Survival | It predicts the number of  | numeric  | FROM 1 TO 107   |
    | Months   | months to live based on    |          |                 |
    |          | the patient state          |          |                 |
    +----------+----------------------------+----------+-----------------+
    | Status   | describes weather the      | as       | Dead , alive    |
    |          | patient is dead or alive   | ymmetric |                 |
    |          |                            | binary   |                 |
    +----------+----------------------------+----------+-----------------+
...
+------------+-------------------------------------------------------+
| Mining     | Comparison Criteria                                   |
| task       |                                                       |
+============+=======================================================+
| Clas       | +-----+------------+-------------+-------------+      |
| sification | |     | 70%        | 80%         | 60%         |      |
|            | |     | training   | training    | training    |      |
|            | |     | 30%        | 30% testing | 40% testing |      |
|            | |     | testing    |             |             |      |
|            | +=====+============+=============+=============+      |
|            | | |   | |          | |        |  | |        |  |      |
|            | |     |       |    |          |  |          |  |      |
...
|            | | |-- | -|---|---| | | IG     |  | | IG     |  |      |
|            | | --- | | I        | IG ratio |  | IG ratio |  |      |
|            | | --- | G     | IG | Gini idex | | Gini idex | |      |
|            | | --- |  ratio | G | | 0.9002 |  | | 0.9058 |  |      |
|            | | --| | ini idex | | 0.9002   |  | 0.9033   |  |      |
|            | | |   | | 0        | 0.9052    | | 0.9058    | |      |
|            | |     | .8844 | 0. | | 0.7594 |  | | 0.8248 |  |      |
|            | |     | 8861   | 0 | 0.7808   |  | 0.8346   |  |      |
|            | |     | .8886    | | 0.7777    | | 0.8248    | |      |
|            | |   | | | 0        | | 0.4958 |  | | 0.4708 |  |      |
|            | | | A | .7982 | 0. | 0.4710   |  | 0.4416   |  |      |
|            | | ccu | 7868   | 0 | 0.5206    | | 0.4708    | |      |
|            | | rac | .8067    | | | 0.9720 |  | | 0.9824 |  |      |
|            | | y   | | 0        | 0.9765   |  | 0.9846   |  |      |
|            | |   | | .4396 | 0. | 0.9735    | | 0.9824    | |      |
|            | | | P | 4637   | 0 |             |             |      |
|            | | rec | .4637    | |             |             |      |
|            | | isi | | 0        |             |             |      |
|            | | on  | .9769 | 0. |             |             |      |
...
|            | |                    | K=3    | K=4    | K=5    |     |
|            | +====================+========+========+========+     |
|            | | Average Silhoutte  | 0.38   | 0.31   | 0.30   |     |
|            | | width              |        |        |        |     |
|            | +--------------------+--------+--------+--------+     |
|            | | total              | 1      | 1      | 9      |     |
|            | | within-cluster sum | 2      | 0      | 4      |     |
|            | | of square          | 848.44 | 358.26 | 03.861 |     |
|            | +--------------------+--------+--------+--------+     |
