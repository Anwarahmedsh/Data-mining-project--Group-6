...
#This scatter plot has no correlation although we can see that when the tumor size is small the women is more likely to live more months which make sense
```
