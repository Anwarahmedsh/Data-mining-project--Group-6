...
bcubed_precision_recall <- function(labels_true, labels_pred) {
  ...
  for (i in 1:num_points) {
    ...
    common_points <- sum(labels_true == true_label & labels_pred == pred_label)
...
precision_recall <- bcubed_precision_recall(selected_data$Cluster, cluster_assignments)
