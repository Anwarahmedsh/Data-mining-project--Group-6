...
ggplot(selected_data, aes(x = Age, y = Survival.Months, color = Cluster)) +
  ...
  labs(title = "K-Medoids Clustering", x = "Age", y = "Survival.Months")
```
#here we evaluated the cluster, by determining the number of clusters we can control the proper granularity of cluster analysis, also choosing the optimal number of clusters can help represinying the data in the best way possible 
...
```
even though i made all coloums numreic, removed the missing vaules, tried another methods like k-means, hierarchial methods, still i encontered errors. but here is the code
```{r}
# Calculate BCubed precision and recall
bcubed_precision <- cluster.stats(cluster_assignments, dataset)$avg.precision
bcubed_recall <- cluster.stats(cluster_assignments, dataset)$avg.recall

# Print the results
cat("Silhouette coefficient:", silhouette_coefficient, "\n")
cat("BCubed precision:", bcubed_precision, "\n")
cat("BCubed recall:", bcubed_recall, "\n")
