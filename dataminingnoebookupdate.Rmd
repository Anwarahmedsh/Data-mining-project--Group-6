...
print(wcss)
```
#the WCSS value is 12848.44. The higher the WCSS value, the greater the dispersion of data points within each cluster, indicating less compact and well-separated clusters.
